...
| v1.5 | 2026-01-31 | 功能新增 | 新增 Bug 自动触发 Agent 2 功能 | 测试发现 bug 时自动激活 Agent 2 | Agent 1 |
| v1.5 | 2026-01-31 | 缺陷修复 | 修复 signoff 支持 passed 状态 | 测试通过后可正常签署 | Agent 1 |
...
| 版本 | 日期 | 变更类型 | 变更内容 |
|-----|------|---------|---------|
| v1.5 | 2026-01-31 | 功能新增 | Git 自动同步功能 (AutoGitSyncEngine) |
| v1.5 | 2026-01-31 | 功能新增 | 文档自动添加git功能 (AutoDocGitAddEngine) |
| v1.5 | 2026-01-31 | 功能新增 | Bug自动触发Agent 2功能 |
| v1.5 | 2026-01-31 | 缺陷修复 | signoff 支持 passed 状态 |
