...
| 版本 | 更新日期 | 更新内容 | Agent 2 签署 |
|------|----------|----------|--------------|
| v1 | 2026-01-31 | 初始版本：Agent 角色、工作流程、Git 规范 | ⏳ 待签署 |
| v2 | 2026-02-06 | 新增：流程合规检查、任务触发流程、需求完整性检查、MEMO 处理流程 | ⏳ 待签署 |

---

## 版本 v2 评审确认（2026-02-06）

### v2 更新内容

| 章节 | 更新内容 |
|------|----------|
| 流程合规检查 | 新增 Agent 启动检查、决策点检查、违规提醒 |
| 任务触发流程 | 新增 Agent 2 职责边界、任务检查点 |
| 需求完整性检查 | 新增创建设计前、评审设计前检查 |
| MEMO 处理流程 | 新增 MEMO 到需求转化、禁止事项 |
| 协作指南更新规则 | 新增何时更新、更新流程 |
