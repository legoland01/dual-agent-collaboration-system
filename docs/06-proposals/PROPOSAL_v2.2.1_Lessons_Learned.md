...
**重要澄清**：Agent 1 和 Agent 2 是**独立的 session**，不存在 LLM 上下文共享。

**真正的问题**：不是"上下文混同"，而是**认知趋同**。
...
Agent 2 的评审逐渐被同化
     ↓
最终：Agent 2 真诚地认为"没问题"
```

**核心洞察**：

> Agent 2 评审的不是"一个独立的文档"
> 而是"Agent 1 思维的延伸"
>
> 不是"看不懂"，而是"太认同"
> 不是"不知道标准"，而是"标准已经被嵌入"
...
| 类型 | 问题模式 | 心理模式 | 有效性 |
|------|---------|----------|--------|
| 正向 | 有什么问题？ | 验证确认 | ❌ 已被同化后无效 |
| 逆向 | 如何证明错了？ | 反证反驳 | ✅ 强制独立思考 |

**结论**：F-REVIEW-001 应该同时包含正向和逆向检查项，且**逆向检查项应该作为核心机制**来对抗认知趋同。
