...
| 产物 | 位置 | 格式 |
|------|------|------|
| 概要设计文档 | docs/02-design/OUTLINE_vX.X.X.md | Markdown |
...
| v1.0.1 | 2026-02-08 | 新增"后续动作"章节，明确TODO和Git同步要求 | Agent 1 |
| v1.0.2 | 2026-02-09 | 添加SOP四要素结构（Phase2） | Agent 1 |
