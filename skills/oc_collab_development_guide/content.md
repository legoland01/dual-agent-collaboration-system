...
| SOP要素 | 内容 |
|---------|------|
| **1. 触发条件** | 见"1. 开发阶段概述"章节 |
| **2. 操作步骤** | 见"2. 开发流程检查清单"章节 |
| **3. 输出产物** | src/**/*.py, tests/**/*.py |
| **4. 验收标准** | 见"6. 质量保证"章节 |
...
| 阶段 | 步骤 | 操作 |
|------|------|------|
| 开发前 | 1 | 确认设计已签署，查看详细设计 |
| 开发前 | 2 | 更新待办，创建开发分支 |
| 开发中 | 3 | 按设计文档实现模块 |
| 开发中 | 4 | 编写单元测试 |
| 开发后 | 5 | 自检代码评审 |
| 开发后 | 6 | 更新状态为 completed |
...
|------|------|------|
| 源代码 | src/**/*.py | Python |
| CLI命令 | src/cli/*.py | Python |
| 单元测试 | tests/test_*.py | Python |

## 4. 验收标准 ⭐

| 标准 | 检查方法 |
|------|----------|
| 所有功能模块实现完成 | 检查 src/ 目录 |
